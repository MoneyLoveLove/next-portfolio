    ...
    return(   
      <>
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            배운 내용을 활용하여 시도하고 부족한 부분은 채워나가며 꾸준히 성장하도록 노력하겠습니다.</p>
            ...
            <Link Link href="https://somber-shoe-d28.notion.site/d5673f14e826438aa7670272bc13bd23" legacyBehavior>
              <a className="ml-4 inline-flex text-white dark:text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">공부기록 보러가기</a>
              </Link>
            </div>
          </div>      
      </>
